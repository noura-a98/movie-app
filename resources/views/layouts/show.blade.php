...
<div class="movie-info border-b border-gray-800">
    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex flex-none">
            <img src="{{ asset(path: 'img/parasite.jpg') }}" alt="parasite" class="w-64 md:w-96" style="width: 24rem">
        </div>
        <div class="md:ml-24">
          ...
          <span class="md:ml-1 text">85%</span>
        ...
        <p class="text-gray-300 mt-8">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae nisi qui ex tempore totam! Autem consequatur repudiandae aut aliquid amet blanditiis voluptatum maxime corrupti quidem nam? Repellat ipsa doloribus error.
        </p>

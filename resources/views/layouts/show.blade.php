        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 place-items-center">
          @foreach ($movie['credits']['cast']  as $cast )
            @if ($loop -> index < 5)
              <div class="mt-8">
                <a href="#">
                  <img src="https://image.tmdb.org/t/p/w500{{ $cast['profile_path'] }}" alt="parasite" class="hover:opacity-75 transition ease-in-out duraction-150">
                </a>  
                <div class="mt-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 place-items-center">
      @foreach ($movie['images']['backdrops'] as $image )
        @if ($loop-> index < 9 )
          <div class="mt-8">
            <a href="#">
            <img src="https://image.tmdb.org/t/p/w500{{ $image['file_path'] }}" alt="parasite" class="hover:opacity-75 transition ease-in-out duraction-150">
            </a>      
          </div>
